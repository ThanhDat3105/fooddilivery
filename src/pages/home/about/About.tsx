            ...
            <div className="container_about container_all">
                ...
                <div className="about_food">
                    ...
                    <div className="about_right">
                        ...
                        <p>Foodeats helps you find and order food from wherever you are. How it works: you type in an address, we tell you the restaurants that deliver to that locale as well as showing you droves of pickup restaurants near you.
                            <br />
                            <br />
                            Want to be more specific? Search by cuisine, restaurant name or menu item. We'll filter your results accordingly.</p>
