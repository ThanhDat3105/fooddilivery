...
export default function Card({
  ...
  const addToCartFc = () => {
    if (infoCard) {
      dispatch(addToCart({ ...infoCard, quantity: number }));
    }
  };
    ...
    <div className={`card `}>
      <div className="container_all">
        <div className={`card_food ${size}`}>
          <p className="back_res" onClick={() => router.push("/menu")}>
            <IoIosArrowBack className="icon_back" /> Back to The Burger Cafe
          </p>
          <div className="content_card">
            ...
            <div className="content_right">
              ...
              <div className="card_cmt">
                <Form.Control
                  placeholder="Ad any request here"
                  as="textarea"
                  rows={7}
                  className="textarea_cmt"
                />
              </div>
              <div className="right_add">
                <div className="number_right">
                  <div className="decrease" onClick={() => decreaseNumber()}>
                    -
                  </div>
                  <div className="number">{number}</div>
                  <div className="increase" onClick={() => increaseNumber()}>
                    +
                  </div>
                </div>
